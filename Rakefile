...
desc 'Generate documentation for the geo_settings extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'GeoSettingsExtension'
...
desc 'Test the geo_settings extension.'
...
namespace :test do
  desc 'Functional test the geo_settings extension.'
  ...
  desc 'Unit test the geo_settings extension.'
